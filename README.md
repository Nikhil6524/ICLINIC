...
## 12. Notes about generated files

I have intentionally not documented `__pycache__` artifacts because they are generated bytecode caches, not source files you maintain by hand.
...
If you want, the next useful upgrade would be a second document that explains the code flow line-by-line for only the most important files, such as the WebSocket route, appointment service, auth service, and admin dashboard.
